...
4. Enter the environment variables:
   - `MIGRATE_DATABASE_URL`: the tidb cloud connection string.
   - `DATABASE_URL`: the Prisma Data Proxy connection string, enter anything because you have not set up Prisma Data Proxy yet.
5. Click **Save & Deploy**.

![img/netlify.png](img/netlify.png)

6. [Set up Prisma Data Proxy](#how-to-set-up-prisma-data-proxy) with the GitHub repository you create in step 5.
7. Use the Prisma Data Proxy connection string to update tne DATABASE_URL environment variable.
